...
class Config:
    def __init__(self, path):
        ...
        print("Attempted to read config file:", path)
        print("Files actually read by ConfigParser:", read_files)
        print("Current working directory:", os.getcwd())
        print("Sections found:", cfg.sections())
        ...
        self.cavityLength = float(cfg['geometry']['cavity_length']) #aangepast
        self.cavityWidth = float(cfg['geometry']['cavity_width']) #aangepast
        self.cavityHeight = float(cfg['geometry']['cavity_height']) #aangepast
